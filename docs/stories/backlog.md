...
## Sliced Epics (first backend buildout)

| Epic | Stories | Status |
| --- | --- | --- |
| E01 Foundation | US-001 scaffold, US-002 data model | done |
| E02 QR session | US-005 QR -> open order | done |
| E03 Menu (read) | US-006 menu browse | done |
| E04 Ordering | US-007 add + submit order | done |
| E05 Realtime | US-008 customer order stream | done |
| E06 Auth & RBAC | US-009 auth + guard, US-010 staff admin | done |
| E07 Kitchen | US-011 queue + status, US-012 sold-out, US-013 staff stream, US-020 served-recent | done |
