...
| Layer | Proof |
| --- | --- |
| Unit | `test/option-groups/option-group-view.test.ts` — view mapping (4 tests: maps a row to admin-facing view; preserves null description and imageUrl for option-groups; handles negative priceDelta for options). |
